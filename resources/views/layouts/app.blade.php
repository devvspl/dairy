                    ...
                    <nav class="flex-1 py-6 space-y-1 overflow-y-auto" :class="sidebarCollapsed ? 'px-2' : 'px-4'">
                        ...
                        @if (auth()->user()->isAdmin())
                            ...
                            <a href="{{ route('admin.support-tickets.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.support-tickets.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2'"
                                style="{{ request()->routeIs('admin.support-tickets.*') ? '' : 'color: var(--muted);' }}"
                                :title="sidebarCollapsed ? 'Support Tickets' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <span class="ml-3 font-medium" x-show="!sidebarCollapsed">Support Tickets</span>
                            </a>

                            <!-- Offers & Engagement Subsection -->
                            <div x-show="!sidebarCollapsed" class="px-3 pt-3 pb-1">
                                <p class="text-xs font-medium" style="color: var(--muted);">Offers & Engagement</p>
                            </div>

                            <!-- Discount Coupons -->
                            <a href="{{ route('admin.coupons.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.coupons.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2 pl-6'"
                                style="{{ request()->routeIs('admin.coupons.*') ? '' : 'color: var(--muted);' }}"
                                :title="sidebarCollapsed ? 'Discount Coupons' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z">
                                ...
                                <span class="ml-3 font-medium" x-show="!sidebarCollapsed">Discount Coupons</span>
                            </a>
                            ...
                            {{-- <a href="{{ route('admin.referral-codes.index') }}"
                                ...
                                :title="sidebarCollapsed ? 'Referral Codes' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            {{-- <a href="{{ route('admin.loyalty-points.index') }}"
                                ...
                                :title="sidebarCollapsed ? 'Loyalty Points' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <!-- Locations -->
                            <div x-show="!sidebarCollapsed" class="px-3 pt-3 pb-1">
                                <p class="text-xs font-medium" style="color: var(--muted);">Content</p>
                            </div>

                            <a href="{{ route('admin.locations.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.locations.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2 pl-6'"
                                style="{{ request()->routeIs('admin.locations.*') ? '' : 'color: var(--muted);' }}"
                                ...
                                <span class="ml-3 font-medium" x-show="!sidebarCollapsed">Locations</span>
                            </a>
                            ...
                            <a href="{{ route('admin.subscriptions.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.subscriptions.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2 pl-6'"
                                style="{{ request()->routeIs('admin.subscriptions.*') ? '' : 'color: var(--muted);' }}"
                            ...
                            <a href="{{ route('admin.milk-prices.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.milk-prices.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2 pl-6'"
                                style="{{ request()->routeIs('admin.milk-prices.*') ? '' : 'color: var(--muted);' }}"
                                :title="sidebarCollapsed ? 'Milk Prices' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                                    </path>
                                </svg>
                                <span class="ml-3 font-medium" x-show="!sidebarCollapsed">Milk Prices</span>
                            </a>
                            ...
                            {{-- <a href="{{ route('admin.deliveries.today') }}"
                                ...
                                :title="sidebarCollapsed ? 'Today\'s Deliveries' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div x-show="!sidebarCollapsed" class="px-3 pt-4 pb-2">
                                <p class="text-xs font-semibold uppercase tracking-wider"
                                    style="color: var(--muted);">SEO</p>
                            </div>

                            <a href="{{ route('admin.seo-metas.index') }}"
                                class="sidebar-link {{ request()->routeIs('admin.seo-metas.*') ? 'active' : '' }} flex items-center rounded-lg transition-all hover:bg-gray-50 text-sm"
                                :class="sidebarCollapsed ? 'justify-center p-3' : 'px-3 py-2'"
                                style="{{ request()->routeIs('admin.seo-metas.*') ? '' : 'color: var(--muted);' }}"
                                :title="sidebarCollapsed ? 'SEO Management' : ''">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                                <span class="ml-3 font-medium" x-show="!sidebarCollapsed">SEO Management</span>
                            </a>
                        @endif
                    </nav>
            ...
            <header class="flex items-center justify-between h-16 px-4 lg:px-6 bg-white border-b"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        ...
                        <a href="{{ auth()->user()->isDeliveryPerson() ? route('delivery.dashboard') : route('member.dashboard') }}"
                ...
                <div class="flex items-center space-x-3 lg:space-x-4">
                    ...
                    <a href="{{ route('home') }}" target="_blank"
                        ...
                        style="color: var(--green);" title="Visit Main Website">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9">
                            </path>
                        </svg>
                        <span class="hidden lg:inline">Go to Home</span>
                    </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <div class="hidden md:block">
                                ...
                                <span class="text-xs"
                                    style="color: var(--muted);">{{ auth()->user()->user_type }}</span>
                            </div>
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <form method="POST"
                                action="{{ auth()->user()->isMember() ? route('member.logout') : route('logout') }}">
                                @csrf
                                <button type="submit"
