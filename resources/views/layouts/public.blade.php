...
<body>
                            ...
                            <span>
                                ...
                                @if ($announcement->link && $announcement->link_text)
                                    | <a href="{{ $announcement->link }}"
                                        style="color: inherit; text-decoration: underline;">{{ $announcement->link_text }}</a>
                                @endif
                            </span>
                        @endforeach
                    </div>
    ...
    <style>
        ...
        .navbar {
            position: sticky;
            top: 70px;
            /* header height ke according adjust */
            z-index: 998;
            background: #fff;
        }
    </style>
        ...
        <div class="container">
            <div class="mainbar-inner">
                ...
                <div class="icons">
                    ...
                    <!-- âœ… Hamburger -->
                    <button class="tb-hamburger" type="button" id="tbMenuBtn" aria-label="Menu"
    ...
    <nav class="navbar" id="navbar" aria-label="Primary">
        <div class="container">
            <ul class="nav">
                ...
                <li><a href="{{ route('blogs') }}" class="{{ request()->routeIs('blogs') ? 'active' : '' }}"><i
                            class="fa-solid fa-pen-to-square"></i> Blogs</a></li>
                <li><a href="{{ route('contact') }}" class="{{ request()->routeIs('contact') ? 'active' : '' }}"><i
                            class="fa-solid fa-envelope"></i> Contact Us</a></li>
            </ul>
        </div>
    </nav>
    <a href="tel:+919999787973"
    ...
    <a href="https://wa.me/919999787973?text=Hello" target="_blank"
        style="position:fixed;
          bottom:20px;
          right:20px;
          background:#25D366;
    ...
    <footer class="tb-footer">
        ...
        <div class="container tb-footer-grid">
            ...
            <div class="tb-foot-news">
                ...
                <form class="tb-foot-form" id="newsletterForm" action="{{ route('contact.submit') }}"
                    method="POST">
                    @csrf
                    ...
                    <input type="hidden" name="message"
                        value="I would like to subscribe to your newsletter for exclusive offers and updates.">
                    <button type="submit" id="newsletterBtn"><span id="newsletterBtnText">Subscribe</span></button>
                </form>

                <!-- Success/Error Messages -->
                <div id="newsletterSuccess"
                    style="display: none; margin-top: 12px; padding: 10px; background: #d1fae5; border-radius: 8px; color: #065f46; font-size: 13px; font-weight: 600;">
                    <i class="fa-solid fa-circle-check"></i> <span id="newsletterSuccessText"></span>
                </div>
                <div id="newsletterError"
                    style="display: none; margin-top: 12px; padding: 10px; background: #fee2e2; border-radius: 8px; color: #991b1b; font-size: 13px; font-weight: 600;">
        ...
        <div class="tb-foot-bottom">
            <div class="container">
                <p>Â© {{ date('Y') }} Nulac Dairy Private Limited. All rights reserved. Designed and Developed by
                    <a target="" href="https://www.apwebworld.com/"
                        style="text-decoration: none; color:white;">Ap Web World</a>
                </p>
            </div>
        </div>
    ...
    <div class="dairy-offcanvas" id="cartOffcanvas">
        ...
        <div id="checkoutHeader"
            style="display:none;align-items:center;justify-content:space-between;padding:16px 20px;background:#2f4a1e;flex-shrink:0;">
            <div style="display:flex;align-items:center;gap:10px;">
                <button id="checkoutBackBtn"
                    style="background:none;border:none;cursor:pointer;color:rgba(255,255,255,.8);font-size:16px;padding:0;line-height:1;">
        ...
        <div id="checkoutTabs" style="display:none;flex-shrink:0;border-bottom:1px solid #e7e7e7;">
            <div style="display:flex;">
                <div id="coTab1"
                    style="flex:1;padding:10px;text-align:center;font-size:12px;font-weight:700;color:#2f4a1e;border-bottom:2px solid #2f4a1e;">
                    <i class="fa-solid fa-list" style="margin-right:3px;"></i>Order
                </div>
                <div id="coTab2"
                    style="flex:1;padding:10px;text-align:center;font-size:12px;font-weight:700;color:#9ca3af;border-bottom:2px solid transparent;">
        ...
        <div class="dairy-offcanvas-body" id="coStep1" style="display:none;">
            ...
            <div style="margin-top:16px;padding-top:16px;border-top:1px solid #e7e7e7;">
                <p
                    style="font-size:12px;font-weight:700;color:#6a7a63;text-transform:uppercase;letter-spacing:.5px;margin:0 0 10px;">
                    Have a coupon?</p>
                <div style="display:flex;gap:8px;">
                    ...
                    <button id="co_coupon_remove_btn" onclick="_removeCoupon()"
                        style="display:none;
        ...
        <div class="dairy-offcanvas-body" id="coStep2" style="display:none;padding:20px;">
            <p
                style="font-size:12px;font-weight:700;color:#6a7a63;text-transform:uppercase;letter-spacing:.5px;margin:0 0 14px;">
                Delivery Details</p>
            <div style="margin-bottom:12px;">
                <label style="display:block;font-size:13px;font-weight:600;color:#1f2a1a;margin-bottom:4px;">Full Name
                    *</label>
            ...
            <div style="margin-bottom:12px;">
                <label style="display:block;font-size:13px;font-weight:600;color:#1f2a1a;margin-bottom:4px;">Phone
                    *</label>
            ...
            <div style="margin-bottom:12px;">
                <label
                    style="display:block;font-size:13px;font-weight:600;color:#1f2a1a;margin-bottom:4px;">Email</label>
                <input type="email" id="co_email" placeholder="Optional"
                    style="width:100%;padding:10px 12px;border:1px solid #e7e7e7;border-radius:10px;font-size:14px;box-sizing:border-box;">
            </div>
            <div>
                <label style="display:block;font-size:13px;font-weight:600;color:#1f2a1a;margin-bottom:4px;">Delivery
                    Address *</label>
            ...
            <div id="co_step2_error"
                style="display:none;margin-top:10px;padding:10px 12px;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;color:#dc2626;font-size:13px;font-weight:600;">
        ...
        <div class="dairy-offcanvas-body" id="coStep3" style="display:none;">
            ...
            <div id="checkoutError"
                style="display:none;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:10px 14px;color:#dc2626;font-size:13px;margin-top:12px;">
            </div>
        </div>
        ...
        <div id="checkoutFooter" style="display:none;padding:16px 20px;border-top:1px solid #e7e7e7;flex-shrink:0;">
            <button id="checkoutNextBtn" onclick="checkoutNext()" class="dairy-offcanvas-btn"
            ...
            async function performSearch(query) {
                ...
                try {
                    const response = await fetch(
                        `{{ route('api.search.products') }}?q=${encodeURIComponent(query)}`);
            ...
            function openCart() {
              ...
              <div class="dairy-offcanvas-empty">
                ...
                <a href="{{ route('products') }}" class="dairy-offcanvas-btn">
                  <i class="fa-solid fa-store"></i> Our Products
                </a>
              </div>
            `;
        ...
        (function() {
            ...
            `;
                ...
                <div class="dairy-offcanvas-item" data-wishlist-item-id="${item.id}">
                  <img src="${itemImage}" alt="${itemName}" class="dairy-offcanvas-img" onerror="this.src='{{ asset('images/products-1.png') }}'">
                  <div class="dairy-offcanvas-info">
                    <a href="${isMilk ? subscribeUrl : productUrl}" class="dairy-offcanvas-name">${itemName}</a>
                    <div class="dairy-offcanvas-price">₹${itemPrice.toFixed(0)}</div>
                    ${isMilk
                      ? `<a href="${subscribeUrl}" class="dairy-offcanvas-btn" style="margin-top:8px;padding:8px 12px;font-size:13px;text-decoration:none;">
                                   <i class="fa-solid fa-droplet"></i> Subscribe Now
                                 </a>`
    ...
    <script>
        ...
        function _showCheckoutStep(step) {
            ...
            if (step === 1) {
                ...
                const total = window._appliedCoupon ? window._appliedCoupon.final_total : (window.DairyCart ? window
                    .DairyCart.getCartTotal() : 0);
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;font-weight:800;font-size:15px;border-top:1px solid #e7e7e7;padding-top:10px;">
          ...
          <span style="color:#2f4a1e;">₹${total.toFixed(0)}</span>
            ...
            @auth
            if (!document.getElementById('co_name').value) document.getElementById('co_name').value =
                '{{ auth()->user()->name ?? '' }}';
            if (!document.getElementById('co_phone').value) document.getElementById('co_phone').value =
                '{{ auth()->user()->phone ?? '' }}';
            if (!document.getElementById('co_email').value) document.getElementById('co_email').value =
                '{{ auth()->user()->email ?? '' }}';
        @endauth
