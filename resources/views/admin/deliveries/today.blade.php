...
<div class="space-y-6">
    ...
    <!-- Filters -->
    <div class="bg-white rounded-lg shadow-sm p-4 border" style="border-color: var(--border);">
        <form method="GET" action="{{ route('admin.deliveries.today') }}" class="flex gap-4">
            <select name="status" class="px-3 py-2 border rounded-lg" style="border-color: var(--border);">
            ...
            <a href="{{ route('admin.deliveries.today') }}" class="px-4 py-2 rounded-lg border font-semibold" style="border-color: var(--border); color: var(--text);">
                Clear
            </a>
        </form>
    </div>
