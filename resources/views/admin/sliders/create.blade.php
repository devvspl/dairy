...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Create New Slider</h2>
    ...
    <form method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="subtitle" rows="3" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">{{ old('subtitle') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="button_text" value="{{ old('button_text') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                    ...
                    <div>
                        ...
                        <input type="text" name="button_link" value="{{ old('button_link') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="link_text" value="{{ old('link_text') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                    ...
                    <div>
                        ...
                        <input type="text" name="link_url" value="{{ old('link_url') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="image" value="{{ old('image') }}" placeholder="Or enter image path manually" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                        <p class="text-xs" style="color: var(--muted);">Upload an image or enter path manually (e.g., uploads/sliders/image.jpg)</p>
