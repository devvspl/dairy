...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Create New Category</h2>
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <select name="icon_type" required class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                    <option value="svg" {{ old('icon_type') == 'svg' ? 'selected' : '' }}>SVG</option>
                    <option value="price" {{ old('icon_type') == 'price' ? 'selected' : '' }}>Price</option>
                </select>
            ...
            <div>
                ...
                <textarea name="svg_path" rows="4" class="w-full px-3 py-2 border rounded-lg font-mono text-sm" style="border-color: var(--border);">{{ old('svg_path') }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="price_text" value="{{ old('price_text') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="bg_color" value="{{ old('bg_color') }}" placeholder="#ffffff" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                ...
                <div>
                    ...
                    <input type="text" name="link" value="{{ old('link') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
        ...
        <div class="flex space-x-3 mt-6">
            <button type="submit" class="px-4 py-2 rounded-lg text-white font-medium" style="background-color: var(--green);">Create Category</button>
