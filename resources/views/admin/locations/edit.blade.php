...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Edit Location Page</h2>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $location->name) }}" required class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., ACE Divino">
                            @error('name')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2" style="color: var(--text);">Slug</label>
                            <input type="text" name="slug" value="{{ old('slug', $location->slug) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="auto-generated">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="sector" value="{{ old('sector', $location->sector) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., 1">
                        ...
                        <div>
                            ...
                            <input type="text" name="area" value="{{ old('area', $location->area) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Greater Noida West">
                        ...
                        <div>
                            ...
                            <input type="text" name="city" value="{{ old('city', $location->city) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Noida">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $location->title) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Bottle Milk Delivery in Sector 1, Greater Noida West">
                        @error('title')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2" style="color: var(--text);">Description</label>
                        <textarea name="description" rows="3" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="Brief description...">{{ old('description', $location->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            <img src="{{ asset($location->banner_image) }}" alt="Current banner" class="h-32 rounded-lg border" style="border-color: var(--border);">
                        </div>
                        @endif
                        ...
                        <p class="text-xs mt-1" style="color: var(--muted);">Recommended: 1920x600px. Leave empty to keep current image.</p>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="building_name" value="{{ old('building_name', $location->building_name) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., ACE Divino">
                        ...
                        <div>
                            ...
                            <input type="text" name="building_type" value="{{ old('building_type', $location->building_type) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Society, Apartment">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="delivery_timing" value="{{ old('delivery_timing', $location->delivery_timing) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., 5:30 AM – 8:30 AM">
                        ...
                        <div>
                            ...
                            <input type="text" name="delivery_point" value="{{ old('delivery_point', $location->delivery_point) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Flat / gate / guard">
                    ...
                    <div>
                        ...
                        <textarea name="handling_info" rows="2" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="Sealed bottles, hygienic delivery...">{{ old('handling_info', $location->handling_info) }}</textarea>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="address" rows="2" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="Complete address...">{{ old('address', $location->address) }}</textarea>
                        @error('address')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2" style="color: var(--text);">Google Maps Embed URL</label>
                        <input type="text" name="map_embed_url" value="{{ old('map_embed_url', $location->map_embed_url) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="https://www.google.com/maps/embed?...">
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="contact_phone" value="{{ old('contact_phone', $location->contact_phone) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="+91XXXXXXXXXX">
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_whatsapp" value="{{ old('contact_whatsapp', $location->contact_whatsapp) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="91XXXXXXXXXX">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" value="{{ old('meta_title', $location->meta_title) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="SEO title...">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="2" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="SEO description...">{{ old('meta_description', $location->meta_description) }}</textarea>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $location->is_active) ? 'checked' : '' }} class="w-4 h-4 rounded" style="accent-color: var(--green);">
                        ...
                        <div>
                            ...
                            <input type="number" name="order" value="{{ old('order', $location->order) }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="0">
