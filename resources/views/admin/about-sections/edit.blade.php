...
<div class="space-y-4 lg:space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
        <form method="POST" action="{{ route('admin.about-sections.update', $aboutSection) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        type="text" 
                        name="kicker" 
                        value="{{ old('kicker', $aboutSection->kicker) }}"
                ...
                <div>
                    ...
                    <input 
                        type="number" 
                        name="order" 
                        value="{{ old('order', $aboutSection->order) }}"
                        min="0"
                        required
                        class="w-full px-3 py-2 border rounded-lg focus:outline-none transition-all"
                        style="border-color: var(--border); color: var(--text);"
            ...
            <div class="border-t pt-6" style="border-color: var(--border);">
                ...
                @if($aboutSection->image)
                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-2" style="color: var(--text);">Current Image</label>
                        <img src="{{ asset($aboutSection->image) }}" alt="Current" class="max-w-xs rounded-lg border" style="border-color: var(--border);">
                    </div>
                @endif
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium mb-2" style="color: var(--text);">Upload New Image</label>
                        <input 
                            type="file" 
                            name="image_file" 
                    ...
                    <div>
                        ...
                        <input 
                            type="text" 
                            name="image" 
                            value="{{ old('image', $aboutSection->image) }}"
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('mini_item_1_title', $aboutSection->mini_items[0]['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('mini_item_1_text', $aboutSection->mini_items[0]['text'] ?? '') }}"
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('mini_item_2_title', $aboutSection->mini_items[1]['title'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('mini_item_2_text', $aboutSection->mini_items[1]['text'] ?? '') }}"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            type="text" 
                            name="badge_rating" 
                            value="{{ old('badge_rating', $aboutSection->badge_rating) }}"
