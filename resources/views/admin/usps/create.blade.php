...
@section('page-title', 'Create USP')

@section('content')
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Create New USP</h2>
    ...
    <form method="POST" action="{{ route('admin.usps.store') }}">
            @csrf
            <div class="space-y-4">
                <div>
            ...
            <div class="flex space-x-3 mt-6">
                <button type="submit" class="px-4 py-2 rounded-lg text-white font-medium" style="background-color: var(--green);">Create USP</button>
