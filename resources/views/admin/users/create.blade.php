...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-xl font-bold" style="color: var(--text);">Create New User</h2>
                <p class="text-sm mt-1" style="color: var(--muted);">Add a new user to the system</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}" x-data="{ loading: false, showPassword: false, showPasswordConfirmation: false, userType: '{{ old('user_type', '') }}' }" @submit="loading = true">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Delivery Person" {{ old('user_type') == 'Delivery Person' ? 'selected' : '' }}>Delivery Person</option>
                    </select>
                    @error('user_type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="password" class="block text-sm font-medium mb-2" style="color: var(--text);">Password <span class="text-red-600">*</span></label>
                    <div class="relative">
                        <input 
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium mb-2" style="color: var(--text);">Confirm Password <span class="text-red-600">*</span></label>
                    <div class="relative">
                        <input 
