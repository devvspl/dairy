<div class="bg-white rounded-xl shadow-sm border overflow-hidden" style="border-color: var(--border);">
    <div class="p-4 lg:p-6">
        <h3 class="text-lg font-bold mb-2" style="color: var(--text);">Location Assignment History</h3>
        <p class="text-sm" style="color: var(--muted);">Track all location assignments and changes for delivery persons</p>
    </div>
