...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Create Announcement</h2>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="e.g., Big Sale">
                        @error('title')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2" style="color: var(--text);">Message * (HTML allowed)</label>
                        <textarea name="message" rows="3" required class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="Get <b>10% OFF</b> on orders above <b>₹3000</b>">{{ old('message') }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="icon" value="{{ old('icon') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="🎉">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="url" name="link" value="{{ old('link') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="https://example.com/sale">
                        ...
                        <div>
                            ...
                            <input type="text" name="link_text" value="{{ old('link_text') }}" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);" placeholder="Shop Now">
