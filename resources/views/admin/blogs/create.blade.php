    ...
    <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs mt-1" style="color: var(--muted);">Max 2MB. Recommended size: 1200x630px</p>
            ...
            <div>
                ...
                <textarea id="editor1" name="content" rows="8" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">{{ old('content') }}</textarea>
