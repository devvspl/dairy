...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    ...
    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
        ...
        @php
            $existingVariants = $productVariants->map(fn($v) => [
                'name' => $v->name,
        ...
        <script>
        let variantRows = {!! $existingVariants !!};
        ...
        <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <label class="flex items-center gap-1.5" title="Clicking this product redirects to member dashboard (for subscription-based products like milk)">
                    <input type="checkbox" name="is_subscription_redirect" value="1" {{ old('is_subscription_redirect', $product->is_subscription_redirect) ? 'checked' : '' }} class="mr-2">
                ...
                <label class="flex items-center gap-1.5" title="Orders for this product will NOT be sent to Shiprocket for fulfilment">
                    <input type="checkbox" name="skip_shiprocket" value="1" {{ old('skip_shiprocket', $product->skip_shiprocket) ? 'checked' : '' }} class="mr-2">
