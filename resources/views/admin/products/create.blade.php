...
<div class="bg-white rounded-xl shadow-sm p-4 lg:p-6 border" style="border-color: var(--border);">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold" style="color: var(--text);">Create New Product</h2>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="badge_color" value="{{ old('badge_color') }}" placeholder="#ffffff" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="rating" value="{{ old('rating') }}" min="0" max="5" step="0.1" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
                ...
                <div>
                    ...
                    <input type="number" name="reviews_count" value="{{ old('reviews_count') }}" min="0" class="w-full px-3 py-2 border rounded-lg" style="border-color: var(--border);">
            ...
            <div>
                ...
                <textarea name="variants" rows="3" class="w-full px-3 py-2 border rounded-lg font-mono text-sm" style="border-color: var(--border);">{{ old('variants') }}</textarea>
